import {Board, Step} from "../../Domain/TicTac/Model";
import {HistoryDataSourceInterface} from "../DataSource";
import {RepositoryInterface} from "../../Domain/TicTac/Repository";

export class Repository implements RepositoryInterface {
    dataSource: HistoryDataSourceInterface;

    constructor(dataSource: HistoryDataSourceInterface) {
